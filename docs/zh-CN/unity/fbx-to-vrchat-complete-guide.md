...
**本页目标**: 提供一套完整的技术工作流，帮助你将从 Marvelous Designer 导出的 FBX 文件打造成可在 VRChat 中以高质量运行的头像。
...
!!! info "事前准备"
    ...
    - 已在 Marvelous Designer 中完成头像与服装制作
    - 已执行 FBX 导出
    - 理解 Unity 的基础操作
...
[VRChat 头像上传与测试 →](avatar-upload.md){ .md-button .md-button--primary }

把制作好的头像实际上传到 VRChat，并在社区中展示出来。
